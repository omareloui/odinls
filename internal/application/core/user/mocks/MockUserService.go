...
func (_m *MockUserService) CreateUser(_a0 *user.User, opts ...user.RetrieveOptsFunc) error {
...
// GetUserByEmailOrUsername provides a mock function with given fields: emailOrUsername, opts
func (_m *MockUserService) GetUserByEmailOrUsername(emailOrUsername string, opts ...user.RetrieveOptsFunc) (*user.User, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// GetUserByEmailOrUsernameFromUser provides a mock function with given fields: usr, opts
func (_m *MockUserService) GetUserByEmailOrUsernameFromUser(usr *user.User, opts ...user.RetrieveOptsFunc) (*user.User, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetUserByEmailOrUsernameFromUser")
	}
...
// GetUserByID provides a mock function with given fields: id, opts
func (_m *MockUserService) GetUserByID(id string, opts ...user.RetrieveOptsFunc) (*user.User, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MockUserService) GetUsers(opts ...user.RetrieveOptsFunc) ([]user.User, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MockUserService) UnsetCraftsmanByID(id string) error {
	ret := _m.Called(id)
...
func (_m *MockUserService) UpdateUserByID(id string, _a1 *user.User, opts ...user.RetrieveOptsFunc) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
